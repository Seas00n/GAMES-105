...
def part1_simple(viewer, target_pos):
    ...
    # joint_position, joint_orientation = part1_inverse_kinematics_example(meta_data, joint_position, joint_orientation, target_pos)
...
def part2(viewer, bvh_name):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            joint_position, joint_orientation = part2_inverse_kinematics(self.meta_data, joint_position, joint_orientation, 0.1, 0.1, 1.4)
...
def main():
    ...
    # part1_animation(viewer, np.array([0.5, 1.4, 0.5]))
    
    # part2
    # part2(viewer, 'data/walk60.bvh')
    
    bonus(viewer, np.array([0.2, 1, 0.5]), np.array([-0.2, 1, 0.5]))
